...
frequencies = extract_frequencies("./text_files/random.txt")
dump(frequencies, "random-frequencies.csv")
build_histogram("random-frequencies.csv", "random-frequencies", 10)
